...
export const fetchUser = createAsyncThunk<UserData>('user/fetchUser', async () => {
  const response = await authController.fetchUser()
  return response
});

export const updateUserProfile = createAsyncThunk<UserData, UserUpdateRequestData>(
...
export const updateUserPassword = createAsyncThunk<void, UserUpdatePasswordRequestData>(
